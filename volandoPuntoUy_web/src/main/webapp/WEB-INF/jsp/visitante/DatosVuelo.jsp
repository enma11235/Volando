...
<body>
	...
	<div class="main-content">
		...
		<div class="item-showcase">
			...
			<div class="details">
				...
				<div>
					...
					<div>
						<p>
							<strong>Móx. Asientos Turista:</strong>
							<%=vuelo.getMaxTurista()%></p>
						<p>
							<strong>Móx. Asientos Ejecutivo:</strong>
		...
		<%
		List<DtReservaWeb> reservas = (ArrayList<DtReservaWeb>) request.getSession().getAttribute("reservasVuelo");
