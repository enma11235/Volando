...
public class datosUsuario extends HttpServlet {
	...
	private static boolean usuarioCargado = false;
	private static boolean rutasCargadas = false;
	private static boolean paquetesCargados = false;
    /**
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
			...
			if (usuario instanceof DtAerolinea) {
				...
				request.setAttribute("paquetes",port.listarPaquetesCompradosClienteWeb(nickUser));
