			...
			<hr>
		      <div class="details">
				...
				<%if (res.getEmbarque() == null) {
					%>
				<form action="${pageContext.request.contextPath}/detallesReserva?action=checkin" method="get">
				    <button type="submit" name="action" value="checkin" class="vuy_button">Realizar Check-In</button>
				</form>
				<%}
					%>
