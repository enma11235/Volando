...
public interface IUserController {
	   ...
	   //Operaciones de Usuarios
	     ...
	     */
	    public abstract UserDTO[] listarUsuariosWeb() throws UsuarioNoExisteException;
	    
	    public abstract List<UserDTO> listarUsuarios() throws UsuarioNoExisteException;
	    
	    public abstract AirlineDTO[] listarAerolineasDataWeb() throws UsuarioNoExisteException;
	     ...
	     */
	    public abstract UserDTO obtenerInfoUsuario(String nickName)throws UsuarioNoExisteException;
	     ...
	     */   
	    public abstract List<BookingDTO> listarReservasCliente(String nickName) throws UsuarioNoExisteException, ReservaNoExisteException;
	    
	    public abstract BookingWebDTO[] listarReservasClienteWeb(String nickName) throws UsuarioNoExisteException, ReservaNoExisteException;
	     ...
	     */   
	    public abstract List<FlightRoutesPackageDTO> listarPaquetesCompradosCliente(String nickName) throws UsuarioNoExisteException, PaqueteNoExisteException;

	    public abstract FlightRoutesPackageWebDTO[] listarPaquetesCompradosClienteWeb(String nickName) throws UsuarioNoExisteException, PaqueteNoExisteException;
