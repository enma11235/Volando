...
public class FlightDTO {
    ...
    private List<BookingDTO> reservas;
    private String imagen;

    public FlightDTO(String nomb, LocalDate fechaVuelo, Duration dura, int maxT, int maxE, int cantT, int cantE,  LocalDate fechaA, List<BookingDTO> res, String imagen) {
    	this.nombre = nomb;
    ...
    public List<BookingDTO> getReservas() {
		return reservas;
	}
