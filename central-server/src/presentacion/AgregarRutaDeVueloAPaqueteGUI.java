...
public class AgregarRutaDeVueloAPaqueteGUI extends JInternalFrame {
	 ...
	 * Create the frame.
	 */
	public AgregarRutaDeVueloAPaqueteGUI(IUserController CU, IFlightRouteController CRV, IPackageController CP) {
		...
		aceptar.addActionListener(new ActionListener () {
			public void actionPerformed(ActionEvent e) {
				...
				if(datosCorrectos) {
					SeatType a = null;
					if(asiento.getSelectedItem() == "Turista") a = SeatType.TURISTA;
					else a = SeatType.EJECUTIVO;
